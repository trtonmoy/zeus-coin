...
const isDarkMode = ()=>document.documentElement.classList.contains("uk-dark")
  , setDarkMode = (e=!0)=>{
    document.documentElement.classList.contains("uk-dark") !== e && (e ? document.documentElement.classList.add("uk-dark") : document.documentElement.classList.remove("uk-dark"),
...
const ENABLE_PAGE_REVEALER_USED = "show" === localStorage.getItem("page-revealer");
{
    ...
    const a = e=>location.protocol === e.protocol && location.origin === e.origin && "_blank" !== e.target && (location.pathname !== e.pathname || location.search !== e.search || !(e.hash || e.href !== e.origin + e.pathname + e.search + e.hash));
    document.addEventListener("click", (async o=>{
        const s = o.target.closest("a");
        s && s instanceof HTMLAnchorElement && !o.defaultPrevented && a(s) && (o.preventDefault(),
        n.style.transition = "transform " + t + "s " + e,
        n.style.visibility = "visible",
        n.style.transform = "scaleY(1)",
        n.style.transformOrigin = "center bottom",
