!function(n, e) {
    ...
    function s(n, e) {
        ...
        function v(n) {
            var t = e ? e * n / 1e3 : n;
            return t = d < 1 ? Math.exp(-t * d * l) * (1 * Math.cos(p * t) + h * Math.sin(p * t)) : (1 + h * t) * Math.exp(-t * l),
            0 === n || 1 === n ? n : 1 - t
        }
        return e ? v : function() {
            var e = r.springs[n];
    ...
    var l, d, p = function() {
        ...
        function a(n, a, o) {
            return ((e(a, o) * n + t(a, o)) * n + r(a)) * n
        }
        function o(n, a, o) {
            return 3 * e(a, o) * n * n + 2 * t(a, o) * n + r(a)
        }
            ...
            if (0 <= e && e <= 1 && 0 <= r && r <= 1) {
                ...
                if (e !== t || r !== u)
                    for (var c = 0; c < 11; ++c)
                        i[c] = a(c * n, e, r);
                return function(n) {
                    return e === t && r === u || 0 === n || 1 === n ? n : a(s(n), t, u)
                }
            }
            function s(t) {
                for (var u = 0, c = 1; 10 !== c && i[c] <= t; ++c)
                    u += n;
                var s = u + (t - i[--c]) / (i[c + 1] - i[c]) * n
                  , f = o(s, e, r);
                return f >= .001 ? function(n, e, t, r) {
                    ...
                    return e
                }(t, s, e, r) : 0 === f ? s : function(n, e, t, r, o) {
                    for (var u, i, c = 0; (u = a(i = e + (t - e) / 2, r, o) - n) > 0 ? t = i : e = i,
    ...
    function B(n, e) {
        return i.dom(n) && !i.inp(n) && (!i.nil(P(n, e)) || i.svg(n) && n[e]) ? "attribute" : i.dom(n) && M(t, e) ? "transform" : i.dom(n) && "transform" !== e && D(n, e) ? "css" : null != n[e] ? "object" : void 0
    }
    function T(n) {
        if (i.dom(n)) {
    ...
    function E(n, e, t, r) {
        ...
        case "transform":
            return function(n, e, t, r) {
                var a, u = o(e, "scale") ? 1 : 0 + (o(a = e, "translate") || "perspective" === a ? "px" : o(a, "rotate") || o(a, "skew") ? "deg" : void 0), i = T(n).get(e) || u;
    ...
    function L(n) {
        ...
        case "polygon":
            return t = (e = n).points,
            S(e) + N(t.getItem(t.numberOfItems - 1), t.getItem(0))
        }
        var e, t, r, a, o
    }
    function j(n, e) {
    ...
    function W(n, e) {
        ...
        i.arr(n)) {
            var r = n.length;
            2 !== r || i.obj(n[0]) ? i.fnc(e.duration) || (t.duration = e.duration / r) : n = {
                value: n
            }
        }
        var a = i.arr(n) ? n : [n];
    ...
    var z = 0
      ...
      , R = function() {
        var n;
        function e(t) {
            for (var r = _.length, a = 0; a < r; ) {
                var o = _[a];
                o.paused ? (_.splice(a, 1),
                r--) : (o.tick(t),
                a++)
            }
        ...
        return "undefined" != typeof document && document.addEventListener("visibilitychange", (function() {
            K.suspendWhenDocumentHidden && (J() ? n = cancelAnimationFrame(n) : (_.forEach((function(n) {
        ...
        function() {
            n || J() && K.suspendWhenDocumentHidden || !(_.length > 0) || (n = requestAnimationFrame(e))
        }
    }();
    function J() {
    ...
    function K(t) {
        ...
        var l, d, p, h, v, g, y, b, M = (d = w(n, l = t),
        h = X(p = w(e, l), l),
        y = Q(g = G(v = $(l.targets), h), p),
        b = z,
        z++,
        k(d, {
            id: b,
        ...
        function I(n) {
            for (var e = 0, t = M.animations, r = t.length; e < r; ) {
                ...
                for (var f = a(n - s.start - s.delay, 0, s.duration) / s.duration, l = isNaN(f) ? 1 : s.easing(f), d = s.to.strings, p = s.round, h = [], v = s.to.numbers.length, g = void 0, y = 0; y < v; y++) {
                    ...
                    b = s.isPath ? q(s.value, l * x, s.isPathTargetInsideSVG) : w + l * (x - w),
                ...
                if (k) {
                    ...
                    g = h[0];
                Y[o.type](u.target, o.property, g, u.transforms),
                o.currentValue = g,
                e++
            }
        }
    ...
    return K.version = "3.2.1",
    K.speed = 1,
    K.suspendWhenDocumentHidden = !0,
    K.running = _,
    K.remove = function(n) {
        for (var e = V(n), t = _.length; t--; )
            nn(e, _[t])
    }
    ,
    K.get = E,
    ...
    ,
    K.setDashoffset = function(n) {
        var e = L(n);
        return n.setAttribute("stroke-dasharray", e),
        e
    }
    ,
    K.stagger = function(n, e) {
        void 0 === e && (e = {});
        var t = e.direction || "normal"
          , r = e.easing ? v(e.easing) : null
          , a = e.grid
          , o = e.axis
          , u = e.from || 0
          , c = "first" === u
    ...
    K.timeline = function(n) {
        ...
        t.add = function(r, a) {
            ...
            f.timelineOffset = i.und(a) ? l : F(a, l),
            c(t),
