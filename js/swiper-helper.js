    ...
    const e = "undefined" != typeof jQuery ? jQuery : null
      ...
      , i = (t,i,o=!1)=>{
        ...
        ));
        {
            ...
            e || (e = i),
            r.navigation && "object" == typeof r.navigation && (r.navigation.nextEl && "string" == typeof r.navigation.nextEl && (r.navigation.nextEl = [...e.querySelectorAll(r.navigation.nextEl)]),
      ...
      , r = (e,n="data-swiper")=>{
        ...
        const s = ()=>{
            const n = new t(e,a);
            n.update(),
            document.addEventListener("DOMContentLoaded", (()=>n.update()), {
                once: !0
            }),
        ...
        if (a.thumbs && a.thumbs.connect) {
            ...
            setTimeout((()=>{
                const t = e[0];
                t && a.thumbs ? (a.thumbs.swiper = t.swiper,
                a.thumbs.swiper ? s() : console.warn(`thumbs connect with selector "${e}" not setup!`)) : console.warn(`thumbs connect with selector "${e}" not exist!`)
            }
            ))
        } else
            s()
