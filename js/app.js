...
});
{
    const t = $(window)
      ...
      , o = .25
      , a = $("[data-viewport-dark]").toArray().map((t=>({
...
document.body.classList.toggle("uni-is-login", "1" === localStorage.getItem("is-login")),
document.querySelectorAll(".uni-login-form, .uni-signup-form").forEach((t=>{
...
));
{
    ...
    $((function() {
        document.querySelectorAll(".uk-droplist").forEach((e=>{
            const o = new t($(e));
            e.classList.contains("uk-droplist-filter") && o.dd.on("change", (()=>{
...
}
{
    ...
    let s, i;
    n.alt = "",
    n.className = "image-hover-revealer",
    ...
    t.forEach((t=>{
        ...
        window.addEventListener("mousemove", (t=>{
            ...
            const i = n.clientWidth
              , r = n.clientHeight;
            o + i >= window.scrollX + window.innerWidth - e && (a ? o -= i : o = window.innerWidth - e - i),
            s + r >= window.scrollY + window.innerHeight && (a ? s -= r : s = window.scrollY + window.innerHeight - r),
...
const stickyItemContrast = (t,e,o,a={})=>{
        ...
        return t=>{
                ...
                return e[t];
            {
                const o = (t=>{
                    ...
                    return (299 * e[0] + 587 * e[1] + 114 * e[2]) / 1e3 >= 128 ? "black" : "white"
                }
                )(t);
                return e[t] = o,
                o
    ...
    const l = ()=>{
        const s = "function" == typeof o ? o(e) : o
          , l = t.map((t=>t instanceof HTMLElement && window.scrollY + s >= t.offsetTop)).lastIndexOf(!0);
        if (-1 === l)
            return;
        const r = (t=>{
            let e = "";
            for (; t && (e = window.getComputedStyle(t, null).getPropertyValue("background-color"),
            /rgba\(.*?,\s*0\)$/.test(e)); )
                t = t.parentElement;
            return e
        }
    ...
    ;
    s.on("scroll resize load darkmodechange", l),
    l()
}
  , getElementParents = t=>{
    const e = [];
  ...
  , stickyItemsDarkMode = (t,e)=>{
    ...
    for (const t of a)
        stickyItemContrast(o, t, e, {
            black: "",
            white: "uk-dark"
        })
}
;
stickyItemsDarkMode(".uni-header, .uni-sticky-menu, .uni-header-social", (t=>t.offsetTop + t.clientHeight / 2)),
stickyItemsDarkMode(".uni-header-location, .uni-header-section-indicator", (()=>window.innerHeight / 2));
{
    const t = document.querySelector(".uni-header-section-indicator");
    if (t) {
        const e = [...t.querySelectorAll("li[data-selector]")].map((t=>document.querySelector(t.getAttribute("data-selector"))))
          , o = $(window);
        let a = 0;
        const n = ()=>{
            const o = window.innerHeight / 2
              , n = e.map((t=>t instanceof HTMLElement && window.scrollY + o >= t.offsetTop)).lastIndexOf(!0);
            -1 !== n && a !== n && (a = n,
            t.style.setProperty("--section-indicator-index", a + ""))
        }
        ;
        o.on("scroll resize load darkmodechange", n),
        n()
    }
}
...
));
{
    ...
    $(".search-form").each((function() {
        ...
        const u = ()=>{
            c && (c = !1,
            l.addClass("uk-hidden"),
            i.removeClass("uk-hidden"))
        }
          , m = t((()=>{
            if (!g)
                return;
        ...
        const h = ()=>{
            s.addClass("uk-hidden"),
            e.off("click mousedown scroll", k),
            g = !1
        }
          , k = t=>{
          ...
          , p = ()=>{
            s.removeClass("uk-hidden"),
            e.on("click mousedown scroll", k),
            g = !0
        }
        ;
        o.on("submit", (t=>{
            ...
            const e = a.val();
            c || (c = !0,
            l.removeClass("uk-hidden"),
            i.addClass("uk-hidden")),
            m(),
...
document.addEventListener("DOMContentLoaded", (t=>{
    $("[data-toggle-active]").on("click", (function(t) {
        t.preventDefault();
        const e = $(this);
        e.toggleClass("active").hasClass("active") ? (e.removeClass(e.attr("data-not-active-class")),
        e.addClass(e.attr("data-active-class"))) : (e.removeClass(e.attr("data-active-class")),
...
$("[data-toggle-loading]").on("click", (function(t) {
    ...
    const e = this
      , o = $(this);
    if (o.hasClass("loading") || o.hasClass("no-more-loading") || !e.toggleLoadingClick || !e.toggleLoadingInsertData)
        return;
    o.addClass("loading"),
    ...
    setTimeout((()=>{
        a.then((t=>{
            e.toggleLoadingInsertData(t) ? (o.attr("disabled", ""),
            o.removeClass("loading"),
            o.addClass("no-more-loading"),
            o.removeClass(o.attr("data-loading-class")),
            o.addClass(o.attr("data-no-more-loading-class"))) : (o.removeClass("loading"),
            o.removeClass(o.attr("data-loading-class")),
...
document.querySelectorAll("[data-load-more]").forEach((t=>{
    ...
    let n = 1;
    e.toggleLoadingClick = ()=>(console.log("url", a),
    fetch(a.replace(/%page%/g, ++n + "")).then((t=>t.text()))),
    e.toggleLoadingInsertData = t=>{
        if (t = t.replace(/<script type="module" src="\/@vite\/client"><\/script>/, ""),
...
$("#uni-audio-play-pause").on("click", (function(t) {
    ...
    0 == playing ? (document.getElementById("uni-background-audio").play(),
    playing = !0) : (document.getElementById("uni-background-audio").pause(),
    playing = !1)
}
));
